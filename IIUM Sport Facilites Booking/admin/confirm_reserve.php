	...
	<nav style = "background-color:rgba(0, 0, 0, 0.1);" class = "navbar navbar-default">
		<div  class = "container-fluid">
			<div class = "navbar-header">
				<a class = "navbar-brand" >Just play. Have fun. Enjoy the game and book yours now!n</a>
			</div>
	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<?php
					$query = $conn->query("SELECT * FROM `booking` NATURAL JOIN `guest` NATURAL JOIN `faci` WHERE `booking_id` = '$_REQUEST[booking_id]'") or die(mysqli_error());
				...
				<form method = "POST" enctype = "multipart/form-data" action = "save_form.php?booking_id=<?php echo $fetch['booking_id']?>">
					...
					<div class = "form-inline" style = "float:left;">
						...
						<br />
						<input type = "text" value = "<?php echo $fetch['faci_type']?>" class = "form-control" size = "20" disabled = "disabled"/>
					</div>
					<div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Court Number</label>
						<br />
						<input type = "number" min = "0" max = "5" name = "faci_no" class = "form-control" required = "required"/>
					</div>
					<br style = "clear:both;"/>
					<br />
